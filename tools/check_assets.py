...
RGBA_EXPECTED = re.compile(r"maglev_(tube|concourse|bridge|tunnel|shelter|terminal|skystop)")
...
LIGHT_EXPECTED = re.compile(r"maglev_(tube|concourse|depot|track|bridge|tunnel|shelter|terminal)")
